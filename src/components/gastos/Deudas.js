...
const handleRangeChange = (event) => {
    ...
    const updatedForm = formDeudas.map(item => {
        if (item.id === id) {
...
const campos = useMemo(() => [
  { id: "PrestamoConsumoInput", label: "Prestamo de Consumo"},
  { id: "TarjetaCreditoInput", label: "Tarjeta de Credito"},
  { id: "MantenimientoInfantilInput", label: "Mantenimiento Infantil"},
  { id: "ImpuestosGubernamentalesInput", label: "Impuestos Gubernamentales"},
